...
class QRCodeInit {
    ...
    companion object{
             ...
             * @throws Exception
             */
            suspend fun qrCodeGenerate(content: String, qrcodeWidth: Int, qrCodeHeigh: Int, logoWidth: Int, logoHeigh: Int, logoPath: String, qrCodeColor: Int): ExternalResource {
                /** 定义Map集合封装二维码配置信息 */
...
//            System.out.println(path);
                    ...
                    /** 在二维码图片中间绘制logo */
                    g.drawImage(logo, (matrixWidth - logoWidth) / 2,
                    ...
                    /** 绘制圆角矩形 */
                    g.drawRoundRect((matrixWidth - logoWidth) / 2,
                        (matrixHeight - logoHeigh) / 2,
